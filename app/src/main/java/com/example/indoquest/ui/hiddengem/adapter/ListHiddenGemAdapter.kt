package com.example.indoquest.ui.hiddengem.adapter
...
class ListHiddenGemAdapter(private val listDestination: ArrayList<Destination>) : RecyclerView.Adapter<ListHiddenGemAdapter.ListViewHolder>() {
